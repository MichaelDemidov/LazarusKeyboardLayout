...
// Warning! Creating multiple instances of the class *in Windows* is pointless
// due to a system hook using this global variable. If you need more than one
// indicator in your application, please think of something to hold a list of
// them and use the single OnUpdateIndicator event handler. Or modify
// TKeyboardLayoutIndicator class to create a list of event handlers instead of
// a single OnUpdateIndicator
var
